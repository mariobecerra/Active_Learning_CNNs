...
plot_title = NULL #"CIFAR10 dataset"
...
(
  ...
  ggsave(filename = paste0(plot_out_dir, "CIFAR10_accuracies_bayesian.png"), 
         .,
         width = out_width,
         height = out_height,
         units = out_units,
...
(
  ...
  ggsave(filename = paste0(plot_out_dir, "CIFAR10_accuracies_pred_ent_ribbon.png"), 
         .,
         width = out_width,
         height = out_height,
         units = out_units,
...
(
  ...
  ggsave(filename = paste0(plot_out_dir, "CIFAR10_accuracies_var_ratios_ribbon.png"), 
         .,
         width = out_width,
         height = out_height,
         units = out_units,
