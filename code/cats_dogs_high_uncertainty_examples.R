...
aaa = readRDS("../out/cats_dogs/var_ratios_2018-12-02_20.30.16/train_pool_ix_var_ratios.rds")


## Hay un logo:
# plot_images(6597)
# aaa = readRDS("~/Dropbox/Mario/Escuela/MCC/Tesis/experiments_git/out/cats_dogs/var_ratios_2018-12-02_20.30.16/train_pool_ix_var_ratios.rds")
# plot_images(aaa$iter_025$id_highest_uncertainty, ncol = n_width)
# plot_images(aaa$iter_020$id_highest_uncertainty, ncol = n_width)
# Imágenes raras:
# plot_images(6597)
# plot_images(18576)
# plot_images(8532)
...
imgs_idx = aaa$iter_020$id_highest_uncertainty
...
# Had to save it by hand because there was some problem with my Mac
ggsave(paste0(out_dir, "plots/cats_dogs_high_uncertainty_examples.png"), examples, 
       dpi = 300, height = n_height, width = n_width, units = "cm")
